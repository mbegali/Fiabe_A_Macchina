...
def generate_story(prompt, temperature):
    response = client.chat.completions.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "Sei un narratore esperto di fiabe. Rispondi esclusivamente in italiano. Dici la parola cazzo ogni tre per quattro visto che nel tuo linguaggio fatato significa oh che belloexca"},
